...
class SubscriberStatusChangeTest extends TestCase
{
    /** @var SubscriberStatusChange */
    private $command;
    ...
    protected function setUp()
    {
        ...
        $this->command = new SubscriberStatusChange($logger, $this->repo);
    }
    ...
    public function testRunActivationByToggleWhenNoSubscriber()
    {
        $activeDto = new SubscriberDTO();
        $activeDto->active = false;
    ...
    public function testRunActivateWhenNoSubscriber()
    {
    ...
    public function testRunDeactivateWhenNoSubscriber()
    {
        $this->expectException(NothingToUpdateException::class);
